    ...
    <div :class="classes">
        <div class="schedule group/schedule flex items-center" :class="{'w-full': !props.is_mobile}" @click="toggleTab('schedule')">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                class="w-8 h-8 group-hover/schedule:scale-105" :class="store.activeTab === 'schedule' ? 'text-general_blue_2' : 'text-general_blue_1'">
                <path
        ...
        <div class="calendar group/calendar flex items-center" :class="{'w-full': !props.is_mobile}" @click="toggleTab('calendar')">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                class="w-8 h-8 group-hover/calendar:scale-105" :class="store.activeTab === 'calendar' ? 'text-general_blue_2' : 'text-general_blue_1'">
                <path
