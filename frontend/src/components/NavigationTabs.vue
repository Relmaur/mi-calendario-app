...
const addSubjectHanlder = () => {
    add_subject_popup.addSubjectOpen();
}
    ...
    <div :class="classes">
        <div class="schedule group/schedule flex justify-between items-center" :class="{ 'w-full': !props.is_mobile , 'active': tabs.getActiveTab() === 'schedule'}" @click="toggleTab('schedule')">
            <div class="title-and-icon flex justify-start items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                    class="w-7 h-7 group-hover/schedule:scale-105"
            ...
            <div class="add-subject p-[2px] border border-general_gray_2 rounded-md" @click="addSubjectHanlder">
        ...
        <div class="calendar group/calendar flex justify-between items-center"
            ...
            <div class="title-and-icon flex justify-start items-center gap-2">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                    class="w-7 h-7 group-hover/calendar:scale-105"
                    :class="tabs.getActiveTab() === 'calendar' ? 'text-general_green_3' : 'text-general_gray_2'">
                    <path
            ...
            <div class="add-subject p-[2px] border border-general_gray_2 rounded-md" @click="">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-4 h-4">
                    <path fill-rule="evenodd"
                        d="M12 3.75a.75.75 0 01.75.75v6.75h6.75a.75.75 0 010 1.5h-6.75v6.75a.75.75 0 01-1.5 0v-6.75H4.5a.75.75 0 010-1.5h6.75V4.5a.75.75 0 01.75-.75z"
                        clip-rule="evenodd" />
