    ...
    <div class="search-bar-and-user">
        <div class="close-sidebar hidden lg:block p-1 border self-center rounded-md hover:cursor-pointer" :class="menuOpened ? 'border-general_green_3' : 'border-general_gray_2'" @click="menu_toggler">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                class="w-6 h-6" :class="menuOpened ? 'text-general_blue_1' : 'text-black'">
        ...
        <div class="search-and-user flex justify-end w-auto gap-3">
            <div
            ...
            <div class="user">
                <div class="user-image relative group/user_image">
                    <div
                        class="settings-icon absolute z-99 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full rounded-full flex justify-center items-center transition group-hover/user_image:backdrop-brightness-75">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                            class="w-7 h-7 text-white opacity-0 transition rotate-12 group-hover/user_image:opacity-100 group-hover/user_image:rotate-0">
                    ...
                    <img src="../assets/img/user-pic.png" alt="User Image" class="rounded-full">
                </div>
            </div>
        </div>
    </div>
